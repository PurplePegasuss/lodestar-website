...
const team_members: TeamMember[] = [
  ...
  },
  {
    ...
    position: 'Инженер-разработчик',
    description: 'Реализует алгоритмы компьютерного зрения на базе ROS с использованием LiDAR. Создает веб-интерфейс для управления роботом.',    
    photo: '/media/elizaveta.jpg',
  },
  {
    name: 'Назаров Артём',
    position: 'Инженер-разработчик',
    description: 'Реализует алгоритмы компьютерного зрения на базе ROS с использованием камер. Интегрирует сенсоры GNSS в систему.',    
